      ...
      <motion.div
        ...
        <motion.div 
          ...
          <img 
            src={logo} 
            alt="P-CON" 
            className="w-full max-w-[15rem] sm:max-w-[18rem] h-auto drop-shadow-[0_12px_36px_hsl(var(--primary)/0.35)] brightness-0 invert opacity-90 -mt-8 -mb-14"
        ...
        <motion.div
          ...
          <p className="text-sm sm:text-base text-gray-neutral">
