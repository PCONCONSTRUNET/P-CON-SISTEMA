  ...
  return (
    <Container>
      ...
      <div className="mt-8 z-10 flex justify-center w-full">
        <Link 
          to="/" 
          className="px-6 py-3 bg-white text-black font-semibold rounded-lg hover:bg-gray-200 transition-colors shadow-lg z-50 absolute bottom-10"
        >
...
const Container = styled.div`
  ...
  background-color: #0f172a; /* keeping dark theme logic from dashboard */
  position: relative;
`;
